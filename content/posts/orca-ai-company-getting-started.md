---
title: Orca AI Company로 블로그를 자동 운영하는 법
slug: orca-ai-company-getting-started
...
category: guide
seo:
  title: Orca AI Company로 블로그 자동 운영하기
...
geo:
  ...
  targetMarkets:
    - KR
  answerSummary: >-
    Orca AI Company는 web(블로그)·admin(검수)·agents(에이전트 팀)·wiki(지속 메모리)로 구성된 모노레포
...
Orca AI Company는 이 두 구멍을 구조로 막는다.
...
```bash
pnpm install
pnpm setup     # 의존성 검사 + 조직 팔로우 + 레포 스타
